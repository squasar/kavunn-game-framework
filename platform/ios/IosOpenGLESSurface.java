...
public class IosOpenGLESSurface implements IosSurface {
    ...
    public IosOpenGLESSurface(
        ...
        this.backend = Objects.requireNonNull(backend, "iOS surface requires an OpenGL ES backend.");
    }
    ...
    public void onSurfaceChanged(int widthPoints, int heightPoints, float scaleFactor) {
        ...
        this.backend.getOpenGLESBridge().viewport(0, 0, this.pixelWidth, this.pixelHeight);
    }
